...
def compute_predictions(image_id, model, mean_image=None, std_image=None, batch_size=4):
    Y_predictions = np.zeros((3348, 3403, model.output_shape[1]), dtype=np.float32)
    tile_size = (256, 256)
